...
@section('header')
    <div>
        <h1 class="text-2xl font-semibold text-card-foreground">Edit Profile</h1>
    ...
    <div class="rounded-lg border border-border bg-card text-card-foreground shadow-sm">
        <div class="p-6">
            ...
            <form action="{{ route('profile.password') }}" method="POST" class="space-y-4">
                ...
                <div>
                    <label for="current_password" class="block text-sm font-medium text-card-foreground mb-1">
                        Current Password <span class="text-red-500">*</span>
                    </label>
                    <input type="password" id="current_password" name="current_password" required
                           class="block w-full px-3 py-2 border border-input bg-background rounded-md text-sm placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-ring focus:border-ring @error('current_password') border-red-500 @enderror">

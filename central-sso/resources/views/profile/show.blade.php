...
@section('header')
    <div>
        <h1 class="text-2xl font-semibold text-card-foreground">My Profile</h1>
...
@section('actions')
    <div class="flex space-x-3">
        <a href="{{ route('profile.edit') }}" class="inline-flex items-center justify-center rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 bg-primary text-primary-foreground hover:bg-primary/90 h-10 px-4 py-2">
        ...
        <div class="rounded-lg border border-border bg-card text-card-foreground shadow-sm">
            <div class="p-6">
                ...
                <div class="space-y-3">
                    ...
                    <div class="flex justify-between">
                        <span class="text-muted-foreground">Admin Status:</span>
                        <span>
                            @if($user->is_admin)
